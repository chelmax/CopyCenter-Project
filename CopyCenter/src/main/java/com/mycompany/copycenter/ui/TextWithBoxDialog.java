 ...
 * @author max19
 */
public class TextWithBoxDialog extends javax.swing.JDialog {
    
    private final TextWithBox model;
     ...
     */
    public TextWithBoxDialog(java.awt.Frame parent, boolean modal, TextWithBox model, String[] ordersID) {
        super(parent, modal);
        this.model = model;
    ...
    private void initComponents() {
        ...
        textLabel.setText(model.getInfoText());
